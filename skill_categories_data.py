...
# Do not hand-edit; regenerate from ESI instead if the game adds/removes skills.
#
# 510 of 526 real, player-trainable skills are covered. The 16 excluded are
# corp/alliance leadership and sovereignty skills (CFO Training, Chief
# Science Officer, Corporation Management, Diplomatic Relations, Empire
# Control, Intelligence Analyst, Megacorp Management, Public Relations,
# Sovereignty, Starbase Management) and structure-siege-weapon skills
# (Mercenary Den Management, Starbase Defense Management, Structure
# Doomsday Operation, Structure Electronic/Engineering/Missile Systems) —
# none of these fit a personal ship-flying playstyle category. NPC/lore-only
# ship skills (Jove *, Precursor *, EDENCOM *, Concord, Flag Cruisers,
# Omnipotent, Polaris) and debug artifacts (TEST Drone Skill, Test) are
# excluded as not actually player-trainable/relevant.
#
# CORE_TARGETS holds the original hand-picked "this actually matters"
# skills per category with specific recommended levels — always shown
